...
//1. @Controller : 해당 클래스를 applicationContext에 bean으로 등록
	...
	//12. @ResponseBody : 메서드가 반호나하는 값을 응답body에 작성.
...
public class MemberController {
	...
	@InitBinder(value = "joinForm") //model의 속성 중 속성명이 joinForm인 속성이 있는 경우
	...
	public void mypage(@CookieValue(name="JSESSIONID", required = false) String sessionId ,
		...
		cookieGenerator.addCookie(response, "testCookie");
