	...
	<div class ="info file_info">
		<c:if test="${not empty files}">
			<ol>
				...
				<li>
				<a onclick="downloadQueryString(${file.originFileName}','${file.renameFileNmae}','${file.savePath})">${file.originFileName}</a></li>
				</c:forEach>
			</ol>
		</c:if>
	</div>
...
<script type="text/javascript">
	let downloadQueryString = (originFileName,renameFileNmae,savePath) => {
